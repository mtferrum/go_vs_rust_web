# Сравнительный анализ веб-серверов на Go, Rust, Forth, Prolog и Ladder

## Обзор проекта

Были созданы пять веб-серверов с REST API для управления пользователями:
...
- **Prolog сервер** (порт 8083) - использует декларативный подход с базой знаний
- **Ladder сервер** (порт 8084) - использует релейную логику и структурированное программирование

## Функциональность

Все пять серверов предоставляют одинаковый API:
